...
const A: Schema = {
  username: { type: "string", required: true, title: "Username", description: "Enter your username", minLength: 5, maxLength: 20},
  ...
  address: {
    ...
    required: true,
    params: {
      street: { type: "string", required: true, minLength: 5, maxLength: 20},
      city: { type: "string", required: true, minLength: 5, maxLength: 20 },
      zipcode: { type: "string", required: true, minLength: 5, maxLength: 20 },
    },
    title: "Legal Address",
...
const B: Schema = {
  account_name: { type: "string", min: 5, required: true, minLength: 5, maxLength: 20 },
  storage_limit: { type: "number", required: true, minValue: 10, maxValue: 9086},
  is_active: { type: "boolean", required: true },
  contact_email: { type: "string", required: true, minLength: 5, maxLength: 20 },
...
const C: Schema = {
  app_name: { type: "string", min: 3, required: true, minLength: 3, maxLength: 20 },
  ...
  support_email: { type: "string", required: true, minLength: 5, maxLength: 20 },
  features: {
    type: "object",
    params: {
  ...
  config_feature_a: {
    type: "object",
    params: {
      config_a: { type: "string", required: true, minLength: 5, maxLength: 20 },
  ...
  config_feature_b: {
    type: "object",
    params: {
      config_c: { type: "string", required: true, minLength: 5, maxLength: 20 },
